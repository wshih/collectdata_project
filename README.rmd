...
Seventeen main variable measurements were collected from the accelerometers (see list below), and some of these variables were measured in 3 different axial directions: X, Y, and Z. Therefore, there was a total of 33 main variable measurements.
tBodyAcc-X,Y,Z
tGravityAcc-X,Y,Z
tBodyAccJerk-X,Y,Z
tBodyGyro-X,Y,Z
...
The names can be found in the codebook. 
